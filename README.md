...
[27. Дайте определение принципа абстракции в ООП?](/27_Дайте_определение_принципа_абстракции_в_ООП.md)
...
[31. Что такое SOLID? Приведите примеры.](/Что_такое_SOLID_Приведите_примеры.md)
...
[35. Что такое класс POJO? Приведите пример такого класса.](/35_Что_такое_класс_POJO_Приведите_пример_такого_класса.md)   
[36. Какие элементы могут содержать класс?](/36_Какие_элементы_могут_содержать_класс.md)   
[37. Дайте определение объекта.](/37_Дайте_определение_объекта.md)   
...
[39. Что такое сигнатура метода? Приведите примеры правильных и неправильных сигнатур.](/39_Что_такое_сигнатура_метода_Приведите_примеры_правильных_и_неправильных_сигнатур.md)   
...
[42. Из каких элементов состоит заголовок класса? Напишите пример.](/42_Из_каких_элементов_состоит_заголовок_класса_Напишите_пример.md)   
[43. Из каких элементов состоит заголовок метода? Напишите пример.](/43_Из_каких_элементов_состоит_заголовок_метода_Напишите_пример.md)   
[44. Создайте в объекте-наследнике конструктор по умолчанию, если в базовом классе он не определен (но определен другой конструктор).](/44_Создайте_в_объекте-наследнике_конструктор_по_умолчанию_если_в_базовом_классе_он_не_определен_(но_определен_другой_конструктор).md)   
...
[47. Для наследования класса public class Child extends Parent напишите порядок инициализации объекта.](/47_Для_наследования_класса_public_class_Child_extends_Parent_напишите_порядок_инициализации_объекта.md)   
...
[51. Назовите основную особенность статических переменных и методов.](/51_Назовите_основную_особенность_статических_переменных_и_методов.md)   
...
[72. Дайте характеристику String в Java.](/72_Дайте_характеристику_String_в_Java.md)   
...
[75. Предложите алгоритм преобразования строки в знак. Напишите соответствующий код.](/75_Предложите_алгоритм_преобразования_строки_в_знак_Напишите_соответствующий_код.md)   
[76. Как превратить строку в массив байтов и обратно? Напишите соответствующий код.](/76_Как_превратить_строку_в_массив_байтов_и_обратно_Напишите_соответствующий_код.md)   
...
[79. Как разделить строку на части? Напишите соответствующий код.](/79_Как_разделить_строку_на_части_Напишите_соответствующий_код.md)   
...
[82. Дайте краткую характеристику Enum в Java.](/82_Дайте_краткую_характеристику_Enum_в_Java.md)   
...
[93. Напишите пример Enum.](/93_Напишите_пример_Enum.md)   
...
[97. Назовите основные свойства транзакций.](/97_Назовите_основные_свойства_транзакций.md)   
...
[100. Расскажите об итераторах и об их применении.](/100_Расскажите_об_итераторах_и_об_их_применении.md)   
...
[110. Дайте краткую характеристику class object в Java.](/110_Дайте_краткую_характеристику_class_object_в_Java.md)   
...
[119. Напишите методы Equals and HashCode для класса Student, который состоит из полей String name и int age.](/119_Напишите_методы_Equals_and_HashCode_для_класса_Student_который_состоит_из_полей_String_name_и_int_age.md)   
[120. В чем разница применения `if (obj instanceof Student) и if (getClass() == obj.getClass())`?](/120_В_чем_разница_применения_ifobj_instanceof_StudentgetClass_objgetClass.md)   
[121. Дайте краткую характеристику метода clone().](/121_Дайте_краткую_характеристику_метода_clone().md)   
...
[123. Дайте определение понятию exception (исключительная ситуация).](/123_Дайте_определение_понятию_exception_(исключительная_ситуация).md)   
...
[126. Какая разница между checked и unchecked, exception, throw, throws.](/126_Какая_разница_между_checked_и_unchecked_exception_throw_throws.md)   
...
[132. Напишите пример перехвата и обработки исключения в блоке try-catch метода.](/132_Напишите_пример_перехвата_и_обработки_исключения_в_блоке_try-catch_метода.md)   
[133. Напишите пример перехвата и обработки исключения в секции throws-метода и передачи вызывающему методу.](/133_Напишите_пример_перехвата_и_обработки_исключения_в_секции_throws-метода_и_передачи_вызывающему_методу.md)   
[134. Напишите пример перехвата и обработки исключения с использованием собственных исключений.](/134_Напишите_пример_перехвата_и_обработки_исключения_с_использованием_собственных_исключений.md)   
...
[137. Напишите пример обработки нескольких исключений в одном блоке catch.](/137_Напишите_пример_обработки_нескольких_исключений_в_одном_блоке_catch.md)   
[138. Какой оператор позволяет принудительно выбросить исключение? Напишите пример.](/138_Какой_оператор_позволяет_принудительно_выбросить_исключение_Напишите_пример.md)   
...
[140. Напишите пример try with resources.](/140_Напишите_пример_try_with_resources.md)   
...
[148.Matrix Diagonal Sum(задача с Leetcode).](/148 Matrix_Diagonal_Sum (задача_с_Leetcode).md)   
[149.Move Zeroes(задача с Leetcode).](/149 Move_Zeroes (задача_с_Leetcode).md)   
[150. Дан List <String> names. Удалите первую букву из каждого имени и верните отсортированный список.](/150_Дан_List_<String>_names_Удалите_первую_букву_из_каждого_имени_и_верните_отсортированный_список.md)   
[151. Перевернуть массив.](/151_Перевернуть_массив.md)   
[152. Проверить, является ли строка палиндромом.](/152_Проверить_является_ли_строка_палиндромом.md)   
...
[154. Напишите алгоритм (последовательность действий) составления литерала типа int и литералов типа byte. Объясните, что происходит с памятью.](/154_Напишите_алгоритм_(последовательность_действий)_составления_литерала_типа_int_и_литералов_типа_byte_Объясните_что_происходит_с_памятью.md)   
# MIDDLE
...
[3. Какие паттерны GoF вы использовали на практике? Приведите примеры.](/3_Какие_паттерны_GoF_вы_использовали_на_практике_Приведите_примеры.md)   
[4. Что такое прокси-объект? Приведите примеры.](/4_Что_такое_прокси-объект_Приведите_примеры.md)   
[5. Какие нововведения анонсировано в Java 8?](/5_Какие_нововведения_анонсировано_в_Java_8.md)   
[6. Что такое High Cohesion и Low Coupling? Приведите примеры.](/6_Что_такое_High_Cohesion_и_Low_Coupling_Приведите_примеры.md)   
...
[17. Приведите примеры удачного и неудачного использования Optional.](/17_Приведите_примеры_удачного_и_неудачного_использования_Optional.md)   
...
[38. Как работает Garbage Collector? Расскажите о Reference counting и Tracing.](/38_Как_работает_Garbage_Collector_Расскажите_о_Reference_counting_и_Tracing.md)   
[39. Расскажите о механизме работы autoboxing в Java.](/39_Расскажите_о_механизме_работы_autoboxing_в_Java.md)   
...
[43. Что такое PECS и как используется? Приведите примеры.](/43_Что_такое_PECS_и_как_используется_Приведите_примеры.md)   
...
[47. Что такое и зачем нужен Spring core? Раскройте понятие Inversion of Control и Dependency Injection.](/47_Что_такое_и_зачем_нужен_Spring_core_Раскройте_понятие_Inversion_of_Control_и_Dependency_Injection.md)   
...
[50. Что такое и зачем нужен Hibernate? Раскройте понятие ORM.](/50_Что_такое_и_зачем_нужен_Hibernate_Раскройте_понятие_ORM.md)   
...
[61. Расскажите о приоритетах потоков.](/61_Расскажите_о_приоритетах_потоков.md)   
...
[72. Какое внутреннее строение TreeMap? Рассказать об RBT.](/72_Какое_внутреннее_строение_TreeMap_Рассказать_об_RBT.md)   
...
[78. Что такое нормализация БД? Приведите примеры из реального проекта.](/78_Что_такое_нормализация_БД_Приведите_примеры_из_реального_проекта.md)   
[79. Какие есть виды индексов в БД?](/79_Какие_есть_виды_индексов_в_БД.md)   
[80. Valid parentheses (задача с LeetCode).](/80 Valid_parentheses (задача_с_LeetCode).md)   
[81. Reverse Linked List (задача с LeetCode).](/81 Reverse_Linked_List (задача_с_LeetCode).md)   
[82. Дано String s, найти длину максимального substring без повтора символов.](/82_Дано_String_s_найти_длину_максимального_substring_без_повтора_символов.md)   
[83. Определить, является ли односвязный LinkedList палиндромом.](/83_Определить_является_ли_односвязный_LinkedList_палиндромом.md)   
[1. Когда лучше использовать наследование, а не агрегацию?](/1_Когда_лучше_использовать_наследование_а_не_агрегацию.md)   
[2. Расскажите о принципах работы Kubernetes.](/2_Расскажите_о_принципах_работы_Kubernetes.md)   
...
[5. Расскажите о Java Memory Model.](/5_Расскажите_о_Java_Memory_Model.md)   
...
[19. Что такое deadlock? Какие типы существуют? Нарисуйте схематично, как может произойти.](/19_Что_такое_deadlock_Какие_типы_существуют_Нарисуйте_схематично_как_может_произойти.md)   
...
[26. Каким образом построить monitoring в Java? Расскажите об особенностях использования Java micrometrics или DropWizard, или Prometheus frameworks.](/26_Каким_образом_построить_monitoring_в_Java_Расскажите_об_особенностях_использования_Java_micrometrics_или_DropWizard_или_Prometheus_frameworks.md)   
[27. Опишите механизм работы ORM.](/27_Опишите_механизм_работы_ORM.md)   
...
[36. Опишите механизм инъекции зависимости в Spring.](/36_Опишите_механизм_инъекции_зависимости_в_Spring.md)   
...
[45. Реализовать сервис, который на вход принимает url и возвращает короткую версию (вроде bit.ly/86gfr3).](/45_Реализовать_сервис_который_на_вход_принимает_url_и_возвращает_короткую_версию_(вроде bitly|86gfr3).md)   
